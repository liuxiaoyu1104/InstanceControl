...
def parse_args():
    ...
    parser.add_argument('--pth-model', help='pth model file',default= '/root/autodl-tmp/Sa2VA_7_4gpus_encode_lora/work_dirs/sa2va_4b/iter_15000.pth')
    parser.add_argument(
        '--save-path', type=str, default='./work_dirs/hf_model_15000', help='save folder name')

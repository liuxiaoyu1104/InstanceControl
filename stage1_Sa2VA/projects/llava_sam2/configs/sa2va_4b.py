...
model = dict(
    ...
    mllm=dict(
        ...
        visual_encoder_lora=dict(  # Correct config object.
            type=LoraConfig,
            r=128,
            lora_alpha=256,
            lora_dropout=0.05,
...
refcocog_ann_file_sam ='./stage1.json'


glamm_refcocog_dataset_sam = dict(
    type=RefCOCOgGCGDataset,
    image_folder="",
    data_path=refcocog_ann_file_sam,
    tokenizer=tokenizer,

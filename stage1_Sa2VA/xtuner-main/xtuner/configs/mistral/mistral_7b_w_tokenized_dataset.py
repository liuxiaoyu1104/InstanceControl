...
# The original Mistral template has been overwritten with the InternLM2 chat template, and the new tokenizer has already
# added the special tokens from the InternLM2 chat template.
# See docs/zh_cn/user_guides/finetune_custom_dataset.md.
tokenizer_path = "/new/tokenizer/path"
use_varlen_attn = True

# Data
dataset_folder = "/path/to/sft/data/folder"
# The original Mistral template has been overwritten with the InternLM2 chat template.

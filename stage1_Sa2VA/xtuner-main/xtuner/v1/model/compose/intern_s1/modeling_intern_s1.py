...
class InternS1ForConditionalGeneration(BaseModel):
    ...
    def fully_shard(
        ...
        # TODO: Check whether the remaining modules have already been split by FSDP.

        # NOTE: checkpoint_wrapper can only be applied here for now.
        # TODO: When training only part of the model, checkpointing cannot be enabled because grads become None; support this later if needed.
        ...
        # Note: This assert is critical and must not be removed.

...
class SequenceContext:
    ...
    # TODO(HHA): input_ids should be allowed to be None when only computing loss or in multimodal cases; this is not general enough.
    ...
    device: str | torch.device = "cpu"  # TODO: This area is a bit messy, with device handling scattered around.
    ...
    def split(self, sequence_parallel_mesh: DeviceMesh | None = None) -> Self:
        ...
        if self.input_ids is not None:
            ...
            sp_seq_ctx = self.__class__(
                ...
                # TODO: The lack of a copy method is inconvenient and makes it easy to miss variables.
    ...
    # TODO: Not used for now and may need to be removed.

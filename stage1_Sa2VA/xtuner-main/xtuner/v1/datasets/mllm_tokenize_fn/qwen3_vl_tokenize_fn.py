...
class Qwen3VLTokenizeFunction(BaseMLLMTokenizeFunction):
    def __init__(
        ...
        # Default min_pixels 3136 = 56x56 = 28x28x2x2 = 56x56 pixels; one image uses 4 tokens for the LLM.
        # Default max_pixels 12845056 = 28x28x128x128 = 3584x3584; one image uses 16384 tokens for the LLM.
    ...
    def _truncated_data_item(
        ...
        # If input_ids exceed the per-sample maximum length and are truncated, position_ids must be truncated as well.
    ...
    def calc_num_tokens_multi_modal_get_item(self, data_item: dict) -> CacheItem:
        ...
        # Drop this data item if the image is truncated.
    ...
    def multi_modal_get_item(self, data_item: dict, media_root: str = "") -> QwenVL3DataItem:
        ...
        # The assertion is caught and this data item is dropped.

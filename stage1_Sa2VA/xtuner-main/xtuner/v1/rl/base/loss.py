...
class RLLossContextInputItem(BaseModel):
    ...
    def sp_split(self, sp_mesh: DeviceMesh) -> Self:
        ...
        # No sp_split is needed for old_logprobs and ref_logprobs here because they are generated by model forward.
        # seq_ctx is always sp_split before model forward.
        return type(self)(

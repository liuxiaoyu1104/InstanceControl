...
class RLTrainer:
    ...
    **Examples:**
    ...
    # TODO: Should advantage be computed in DataFlow or in the train controller?
    # Put it here for now because there may be a need to decide whether data enters RL training based on advantage.

...
class UTF8ByteTokenizer:
    ...
    def encode(self, text: str, add_special_tokens: bool = False) -> list[int]:
        ...
        """
        # Strict UTF-8 encoding raises on invalid characters; use errors='ignore' if ignoring is needed.
        b = text.encode("utf-8", errors="strict")
        ids = list(b)  # Each byte is in 0..255.
        ...
        for t in ids:
            ...
            if t < 256:
                ...
                if not skip_special_tokens and t in self.special_ids:
                    # Special symbols are not converted back to characters by default; customize placeholders if needed.
                    pass
                # Ignore all other non-special ids >= 256.

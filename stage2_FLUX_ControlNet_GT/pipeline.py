    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                self._joint_attention_kwargs['attention_mask'] = atten_mask_list
                # self._joint_attention_kwargs['indices_list'] = indices_list
                # self._joint_attention_kwargs['timestep'] = i
                # self._joint_attention_kwargs['position_mask'] =  position_mask
                # self._joint_attention_kwargs['part_prompt'] =part_prompt
